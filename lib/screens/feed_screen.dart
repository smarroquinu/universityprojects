              ...
              builder: (context, snapshot) {
                ...
                return Expanded(
                  child: ResponsiveLatout(
                    ...
                    mobileBody: snapshot.data.docs.length == 0
                        ? Center(
                            child: Column(
                                ...
                                SizedBox(height: 30),
                                Text(
                                    'Ningún stream iniciado todavía, ¡Sé el primero!')
                              ]))
                        : ListView.builder(
                            itemCount: snapshot.data.docs.length,
                            itemBuilder: (context, index) {
                                    ...
                                    children: [
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Text('${post.viewers} viendo'),
                                          Text(
                                            'Iniciado ${timeago.format(post.startedAt.toDate())}',
                                          ),
                                        ],
                                      ),
                                      IconButton(
