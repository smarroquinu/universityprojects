...
class _BroadcastScreenState extends State<BroadcastScreen> {
  ...
  String baseUrl = "https://sivarwatchapi.herokuapp.com";
                      ...
                      Row(
                          ...
                          children: <Widget>[
                            ...
                            InkWell(
                              onTap: onToggleMute,
                              child: Icon(
                                isMuted ? Icons.mic_rounded : Icons.mic_off,
                                size: 35.0,
                              ),
                            ),
                          ]),
                      const Text('Chat:', style: TextStyle(fontSize: 25.0)),
                    ],
                  ),
                Expanded(
                  child: Chat(
